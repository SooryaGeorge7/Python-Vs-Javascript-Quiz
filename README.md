...
transform: translate(-50%, -50%); to achieve the effect of the statement always remaining at the bottom of any screen when playing the game.[View final](documentation/gifs/bugs-gif/copyright-bug-solved.gif)
